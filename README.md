...
repo separata: homelab-monitoring
```
...
| Deploy app       | Docker Compose su `app-host`                           |
| Monitoring       | Repo separata su `monitoring-host`                     |
...
- PostgreSQL/TimescaleDB esterno su `db-host`
- goose
- sqlc
...
Il database principale non e containerizzato in questa compose: deve vivere esternamente su `db-host`.
